...
(function (Stone) {
    ...
    Stone[Stone["SKYSTONE"] = 2] = "SKYSTONE";
})(Stone = exports.Stone || (exports.Stone = {}));
class SkystoneAllianceDetails {
    ...
    fromJSON(json) {
        const alliance = new SkystoneAllianceDetails();
...
exports.default = SkystoneAllianceDetails;
